...
def generate_common_hybrid_launch_description():
    ...
    global_planner_param = load_yaml(
        "ur5_gripper_moveit_config", "config/global_planner.yaml"
    )
    local_planner_param = load_yaml(
        "ur5_gripper_moveit_config", "config/local_planner.yaml"
    )
    hybrid_planning_manager_param = load_yaml(
        "ur5_gripper_moveit_config", "config/hybrid_planning_manager.yaml"
    )
